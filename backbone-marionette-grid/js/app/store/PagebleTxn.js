...
define(['backbone.paginator'], function() {
    var TxnCollection = Backbone.PageableCollection.extend({

        url: Ctx.url('txn.flow.search'),
        ...
        setQueryOptions: function(options){
            this.queryParams.startDate = options.startDate;
            this.queryParams.endDate = options.endDate;
            return this;
        },
        ...
        parseState: function(resp, queryParams, state, options) {
            ...
            */
            ...
            var totalRecords = parseInt(resp.totalCount, 10);
            return {
